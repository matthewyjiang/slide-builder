...
- [x] **M4 - polish.** Help overlay, robust error surfaces (including in-TUI credential login, missing browser, unsupported terminal, and missing fonts), compaction config, and model picker from catalog.
